...
export async function createJob(jobData) {
  try {
    ...
    if (jobData.time) {
      fields['Scheduled Time'] = jobData.time
    }
    if (jobData.confirmed !== undefined) {
      fields['Confirmed'] = jobData.confirmed
    }
    if (jobData.quoteApproved !== undefined) {
      fields['Quote Approved'] = jobData.quoteApproved
    }
